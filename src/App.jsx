...
const fetchWeatherByCoordinates = async (latitude, longitude) => {
  ...
  return (
    <div className={`App ${(toggleMode|| (hours>19 && hours<7) )&&"dark-mode"}`}>
    ...
    {(weather.loading || weather.error) &&
        ...
        {weather.error && (
          <span className="error-message">
            ...
            <span style={{marginLeft:"10px"}}>{input.trim() ===  '' ? 'le champ ville est vide':'Ville introuvable'}</span><br />
      ...
      <div className='contniner-fawi'>
        ...
        <div className="favorites-list">
          ...
          {favorites.length === 0 ?
            <div className='aucune-ville'>Aucune ville n'existe.</div>
            :
          <>
